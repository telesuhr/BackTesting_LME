...
def visualize_1year_backtest(data, result, strategy, strategy_name='bb_rsi', output_file=None):
    ...
    # タイトルに戦略パラメーターを含める
    title = (f'LME Copper - Bollinger+RSI Combined Strategy (15分足, {strategy.fixed_position_size:.0f}MT, '
...
BB: {strategy.bb_period}/{strategy.bb_std}σ
RSI: {strategy.rsi_period} ({strategy.rsi_oversold}/{strategy.rsi_overbought})
