...
使用方法:
    python visualize_backtest_momentum_1year.py
"""
import logging
...
def visualize_momentum_backtest(data, result, strategy, strategy_name='momentum', output_file=None):
    ...
    # タイトルに戦略パラメーターを含める
    title = (f'LME Aluminium - Momentum Strategy (15分足, {strategy.fixed_position_size:.0f}MT, '
...
def main():
    ...
    logger.info("=" * 60)
    logger.info(f"モメンタム戦略 アルミニウム1年間可視化（15分足, 100MT）")
    logger.info("=" * 60)
